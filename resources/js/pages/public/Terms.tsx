        ...
        <PublicLayout>
            <div className="mx-auto max-w-3xl">
                ...
                <div className="prose prose-sm mt-6 max-w-none text-gray-600">
                    <p><strong>1. Nature of contributions.</strong> All amounts you send to {company.name} are voluntary donations to a community fund. They are not investments, loans, deposits, or securities, and they carry no guarantee of return of principal.</p>
                    ...
                    <p className="mt-4"><strong>5. Operator.</strong> This service is operated by <strong>{company.name}</strong> (Registration No: {company.registration}). Address: {company.address}. For questions, email us at: {company.email}.</p>
                </div>
            </div>
        </PublicLayout>
    );
