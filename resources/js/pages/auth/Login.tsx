        ...
        <AuthLayout title="Welcome back" subtitle="Log in to your member account">
            ...
            <form onSubmit={submit} className="space-y-5">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <Link href={route('password.request')} className="text-sm font-bold text-amber-600 hover:text-amber-700 transition-colors">
                        Forgot password?
                    </Link>
                </div>
            ...
            <p className="mt-8 text-center text-sm font-medium text-gray-500">
                New to the club?{' '}
                <Link href={route('register')} className="font-black text-amber-600 hover:text-amber-700 transition-colors">
                    Create an account →
                </Link>
            </p>
        </AuthLayout>
